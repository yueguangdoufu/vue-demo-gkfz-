        ...
        <el-container>
          <el-main>
            <el-breadcrumb separator-class="el-icon-arrow-right">
              ...
              <el-breadcrumb-item>其他高等院校</el-breadcrumb-item>
            </el-breadcrumb>
            <div class="xx_sousuo">
...
export default {
  data () {
    return {
      ...
      searchUrls: [
        '/select_xuexiao_name_qt', '/select_xuexiao_diqu_qt', '/select_xuexiao_wenfen_qt',
        '/select_xuexiao_lifen_qt'
      ],
      searchUrl: '/select_xuexiao_name_qt',
      inputValue: ''
    }
  },
  mounted () {
