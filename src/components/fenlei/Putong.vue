        ...
        <el-container>
          <el-main>
            <el-breadcrumb separator-class="el-icon-arrow-right">
              ...
              <el-breadcrumb-item>普通高等院校</el-breadcrumb-item>
            </el-breadcrumb>
            <div class="xx_sousuo">
...
export default {
  data () {
    return {
      ...
      searchUrls: [
        '/select_xuexiao_name_pt', '/select_xuexiao_diqu_pt', '/select_xuexiao_wenfen_pt',
        '/select_xuexiao_lifen_pt'
      ],
      searchUrl: '/select_xuexiao_name_pt',
      inputValue: ''
    }
  },
  mounted () {
