        ...
        <el-container>
          <el-main>
            <el-breadcrumb separator-class="el-icon-arrow-right">
              ...
              <el-breadcrumb-item>重点高等院校</el-breadcrumb-item>
            </el-breadcrumb>
            <div class="xx_sousuo">
                ...
                <div slot="prepend">
                  <div class="centerClass">
                    <el-select v-model="select" placeholder="请选择" style="width: 90px" @change="optionChange">
                      ...
                      <el-option label="文分" value="3"></el-option>
                      <el-option label="理分" value="4"></el-option>
                    </el-select>
                  </div>
                  <div class="centerClass">
                    <div class="line"></div>
...
export default {
  data () {
    return {
      ...
      searchUrls: [
        '/select_xuexiao_name_gd', '/select_xuexiao_diqu_gd', '/select_xuexiao_wenfen_gd',
        '/select_xuexiao_lifen_gd'
      ],
      searchUrl: '/select_xuexiao_name_gd',
      inputValue: ''
    }
  },
  mounted () {
